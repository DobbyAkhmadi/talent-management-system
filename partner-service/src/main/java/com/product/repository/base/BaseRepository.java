...
@Repository
public interface BaseRepository extends JpaRepository<Partner, UUID> {
    ...
    @Query("SELECT p FROM Partner p WHERE :columnName = :values")
    Partner getByColumns(String columnName, String values);
}
